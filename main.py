...
for symbol in symbols:
    ...
    if change_14d is not None and change_3d is not None and change_14d >= 5 and change_3d <= -5:
        results["گروه اول"].append(symbol)

    if change_7d is not None and change_3d is not None and change_7d >= 4 and change_3d <= -3:
        results["گروه دوم"].append(symbol)

    if change_1d is not None and change_12h is not None and change_1d >= 3 and change_12h <= -3:
